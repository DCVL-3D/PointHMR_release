...
class FastMETRO_Body_Network(nn.Module):
    ...
    def forward(self, cjv_token):
        ...
        cjv_features_1 = self.transformer_1(cjv_token.transpose(0, 1).contiguous(),
                                            mask=self.attention_masks[-1].to(device))
        ...
        pred_3d_vertices_fine = self.mesh_sampler.upsample(pred_3d_vertices_coarse)

        return cam_parameter, pred_3d_joints, pred_3d_vertices_coarse, pred_3d_vertices_fine
